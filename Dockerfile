# Impacta para Empresas (Corporate) — landing page estática servida por nginx
...
# Conteúdo da LP
COPY index.html lp.css app.js favicon.ico robots.txt sitemap.xml /usr/share/nginx/html/
